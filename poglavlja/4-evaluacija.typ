...
- Верификација _Keras_ 3 функционалности: Имплементацијом нових јединичних тестова, доказано је да TFF алгоритми успешно иницијализују, обучавају и евалуирају моделе изграђене коришћењем _Keras_ 3 API-ја.

Код решења се налази на _Github_ репозиторијуму https://github.com/markomitos/tensorflow-federated/pull/1.
Тестови се могу покренути командом у листингу @lst:bazel, где `putanja` представља путању до жељене _Bazel_ целине.
...
bazel test putanja
```),
caption: [Команда за покретање тестова у _Bazel_ инфраструктури, где `putanja` представља
...
Тренутно решења задовољава покриће кода тестовима. Међутим, начин на који су додати тестови
