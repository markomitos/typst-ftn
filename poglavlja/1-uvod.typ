...
_IntelliJ IDEA_, јесте претрага _Search Everywhere_ (SE) која кориснику на једном месту
омогућава да претражи све функционалности окружења, заједно са свим датотекама и њиховим
садржајем унутар пројектне структуре @intellij. На слици @fig:se приказан је пример
...
којим се гарантује поверљивост података. Мана код тренутне имплементације FL у радном окружењу
_TensorFlow Federated_ (TFF) је недостатак подршке за учитавање најновијих модела,
који су потребни да тачно предвиде претрагу SE. Недостатак подршке постоји због
имплементације TFF која се ослања на претходну верзију библиотеке _Keras_, _Keras_ 2,
која за разлику од наредне верзије библиотеке не подржава учитавање модерних модела @tff.
...
- Рефакторисати компоненте TFF-а тако да би се постигла компатибилност са верзијом 3 библиотеком _Keras_,
